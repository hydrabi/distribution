...
- (void)awakeFromNib {
    ...
    self.productNameLabel.font             = [UIFont systemFontOfSize:15.0f];
    self.productNameLabel.text             = @"";
    self.distributePriceLabel.textColor    = [UIColor colorWithHexString:@"ff633b" alpha:1];
    self.distributePriceLabel.font         = [UIFont systemFontOfSize:14.0f];
    ...
    self.distributeLabel.font              = [UIFont systemFontOfSize:14.0f];
    ...
    self.numberTitleLabel.font             = [UIFont systemFontOfSize:14.0f];
    ...
    self.favoriteButton.layer.cornerRadius = 2.0f;
...
-(void)resetValueWithObject:(AVObject*)object{
    ...
    if(user){
    BOOL favorited                 = [user containFavoriteObjectId:object.objectId];
...
-(void)textFieldEditChange:(UITextField*)textField{
    CGRect rect = [self.textField textRectForBounds:self.textField.frame];
