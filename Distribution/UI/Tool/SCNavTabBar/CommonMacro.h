...
#define TAB_BAR_BUTTON_SELECTED_TITLE_COLOR [UIColor colorWithHexString:@"#ff6f3b" alpha:1]
#define TAB_BAR_BUTTON_NORMAL_TITLE_COLOR [UIColor colorWithHexString:@"#686868" alpha:1]
#define TAB_BAR_LINE_COLOR TAB_BAR_BUTTON_SELECTED_TITLE_COLOR
#define TAB_BAR_LINE_WIDTH_PERCENT      0.4  
...
#define NavTabbarColor                  [UIColor colorWithHexString:@"#ffffff" alpha:1]
